                    ...
                    <nav class="mobile-canvas__nav navigation">
                        <ul class="navigation__list">
                            ...
                            <li class="navigation__item">
                                <a class="navigation__link animsition-link" href="#">A Propos de nous<span class="navigation__link-icon">
                                </a>
                            </li>
                            <li class="navigation__item">
                            ...
                            <li class="navigation__item">
                                <a class="navigation__link animsition-link" href="#">Contact<span class="navigation__link-icon">
